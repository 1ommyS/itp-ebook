...
- [:material-language-java: **Java и JVM**](interview/deep/java-core.md) · язык, коллекции, runtime и concurrency
- [:material-database: **Данные**](interview/deep/sql-postgresql.md) · SQL, PostgreSQL, JPA и транзакции
- [:simple-spring: **Spring**](interview/deep/spring-core.md) · контейнер, Boot, Web и Security
...
!!! info "Версии технологий"
    Конспекты делают акцент на устойчивых контрактах и принципах. Параметры конфигурации и детали поведения всегда сверяйте с документацией версии JDK, Spring, PostgreSQL или брокера, которая используется в вашем проекте.
